    ...
    >
      <div className="flex items-center justify-between gap-2">
        <div className="flex items-center gap-2 min-w-0">
          ...
          <span
            className={cx(
              "text-3xs px-1.5 py-0.2 rounded border font-mono font-bold shrink-0",
              badge.bg,
            )}
          >
            {badge.label}
        ...
        <div className="flex items-center gap-1.5 shrink-0">
          <button
            ...
            className="opacity-0 group-hover:opacity-100 focus-visible:opacity-100 hover:bg-[var(--color-surface)] rounded px-1.5 py-0.5 text-3xs text-[var(--color-muted)] hover:text-[var(--color-accent)] border border-transparent hover:border-[var(--color-line)] transition-all flex items-center gap-1"
          >
            <Sparkles
      ...
      <div className="text-2xs text-[var(--color-muted)] line-clamp-1">{email.snippet}</div>

      {email.company && (
        <div className="flex items-center gap-1.5 pt-0.5 text-3xs text-[var(--color-accent)]">
