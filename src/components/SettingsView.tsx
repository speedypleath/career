...
export function SettingsView() {
  ...
  const [gmailAccount, setGmailAccount] = useState("gheorgheandrei13@gmail.com")
  const [imapHost, setImapHost] = useState("imap.gmail.com")
  const [imapPort, setImapPort] = useState(993)
  const [imapUser, setImapUser] = useState("gheorgheandrei13@gmail.com")
  ...
  async function loadSettings() {
    ...
    try {
      ...
      if (data.settings) {
        ...
        setGmailAccount(data.settings.gmail_account || "gheorgheandrei13@gmail.com")
        setImapHost(data.settings.imap_host || "imap.gmail.com")
        setImapPort(data.settings.imap_port || 993)
        setImapUser(data.settings.imap_user || "gheorgheandrei13@gmail.com")
